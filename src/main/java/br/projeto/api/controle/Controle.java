...
import br.projeto.api.modelo.Cliente;
import br.projeto.api.modelo.Pessoa;    
import br.projeto.api.repositorio.Repositorio;
import br.projeto.api.servico.Servico;
...
public class Controle {
    ...
    public List<Pessoa> ordernarNomes2(){
        return acao.findByNomeOrderByIdadeDesc("Henrique");
    }
